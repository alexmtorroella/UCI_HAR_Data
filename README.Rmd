...
Of the 561 variables gathered from the phone sensors we were only interested in those that were means or standard deviations of each measurement. So those columns were subsetted. There is a total of 73 variables representing mean or standard deviation of the measurements.
